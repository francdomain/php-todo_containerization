            ...
            steps {
                script {
                    ...
                    checkout([
                        ...
                        userRemoteConfigs: [[url: 'https://github.com/francdomain/php-todo_containerization.git']]
                    ])
                }
            }
        }
        ...
        stage('Smoke Test') {
            steps {
                script {
                    def response
                    retry(5) {
                        sleep(time: 60, unit: 'SECONDS')  // Increase sleep duration to allow services more time to start
